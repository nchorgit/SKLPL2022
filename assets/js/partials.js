...
.then(data => {
  document.querySelector(".head-comp").innerHTML = data;
});
...
.then(data => {
  document.querySelector(".header-comp").innerHTML = data;
});
...
.then(data => {
  document.querySelector(".footer-comp").innerHTML = data;
});
...
$(".header-comp").load("/partials/header.html")
$(".head-comp").load("/partials/head.html")
$(".footer-comp").load("/partials/footer.html")
      ...
      /*********************************************** 
       ...
       var scrolltotop = {
        ...
        controlHTML: '<img src="/media/svg/totop.svg" style="width:36px; height:36px; transition: all .3s;">', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol" 
        controlattrs: {
            offsetx: 20,
            offsety: 20
        ...
        scrollup: function () {
            ...
            var dest = isNaN(this.setting.scrollto) ? this.setting.scrollto : parseInt(this.setting
                .scrollto)
            if (typeof dest == "string" && jQuery('#' + dest).length ==
                1) //check element set by string exists 
